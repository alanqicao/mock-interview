...
const App = () => {
  ...
  const sortLikebymost = () => {
    const most = items.sort(function (a, b) {
  ...
  const sortLikebyleast = () => {
    const least = items.sort(function (a, b) {
  ...
  return (
    <>
      <div>
        <ButtonGroup>
          <Button basic color="red" onClick={sortLikebymost}>
            Sort by most likes
          </Button>
          <Button.Or />
          <Button positive onClick={sortLikebyleast}>
            Sort by least likes
          </Button>
        </ButtonGroup>
      ...
      <Card.Group>{sort ? renderItems() : renderItems()}</Card.Group>
    </>
  );
};
